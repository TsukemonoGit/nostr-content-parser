...
// Test data
const TEST_NPUB = 'npub1sjcvg64knxkrt6ev52rywzu9uzqakgy8ehhk8yezxmpewsthst6sw3jqcw';
const TEST_NOTE = 'note10vns6zm2xecfs43n40fawleevvtqlc73dv3ptj5xr9nwysywjq9sjyv6r0';
const TEST_NEVENT = '';
const TEST_NPROFILE = 'nprofile1qyxhwumn8ghj77tpvf6jumt9qqsgfvxyd2mfntp4avk29pj8pwz7pqwmyzrummmrjv3rdsuhg9mc9agccpc2g';
...
const sampleTokens = [
 ...
 /*    { type: TokenType.MENTION, content: `nostr:${TEST_NPUB}`, metadata: { entity: TEST_NPUB } }, */
    { type: TokenType.LN_ADDRESS, content: 'alice@getalby.com', metadata: { domain: 'getalby.com' } },
    { type: TokenType.LNBC, content: 'lnbc1pvjluezpp5...' },
    { type: TokenType.BITCOIN_ADDRESS, content: '1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa', metadata: { addressType: 'legacy' } },
...
/*   it('should get mentions', () => {
  ...
  it('should parse multiple NIP-19 entities', () => {
  ...
  it('should parse custom emojis with tags', () => {
  ...
  it('should parse custom emojis without tags', () => {
...
describe('edge cases', () => {
  ...
  it('should handle consecutive same-type tokens', () => {
...
it('should detect npub with and without nostr prefix', () => {
  ...
  it('should handle malformed NIP-19 entities', () => {
    const content = 'npub1short note1toolong123456789012345678901234567890123456789012345678901234567890';
    const tokens = parseContent(content);
...
describe('Lightning and Bitcoin parsing', () => {
  ...
  it('should parse Lightning addresses', () => {
  ...
  it('should distinguish Lightning addresses from regular emails', () => {
  ...
  it('should parse Lightning URLs', () => {
    const content = 'Pay via ';
    const tokens = parseContent(content);
    
    const lnUrls = tokens.filter(t => t.type === TokenType.LN_URL);
    expect(lnUrls).toHaveLength(1);
    expect(lnUrls[0].content).toContain('');
  });

  it('should parse Lightning invoices', () => {
    const content = 'Pay this invoice: lnbc1pvjluezpp5qqqsyqcyq5rqwzqfqqqsyqcyq5rqwzqfqqqsyqcyq5rqwzqfqypqdpl2pkx2ctnv5sxxmmwwd5kgetjypeh2ursdae8g6twvus8g6rfwvs8qun0dfjkxaq8rkx3yf5tcsyz3d73gafnh3cax9rn449d9p5uxz9ezhhypd0elx87sjle52x86fux2ypatgddc6k63n7erqz25le42c4u4ecky03ylcqca784w';
    const tokens = parseContent(content);
    
    const invoices = tokens.filter(t => t.type === TokenType.LNBC);
    expect(invoices).toHaveLength(1);
    expect(invoices[0].content).toContain('lnbc1pvjluezpp5qqqsyqcyq5rqwzqfqqqsyqcyq5rqwzqfqqqsyqcyq5rqwzqfqypqdpl2pkx2ctnv5sxxmmwwd5kgetjypeh2ursdae8g6twvus8g6rfwvs8qun0dfjkxaq8rkx3yf5tcsyz3d73gafnh3cax9rn449d9p5uxz9ezhhypd0elx87sjle52x86fux2ypatgddc6k63n7erqz25le42c4u4ecky03ylcqca784w');
  });

  it('should parse Bitcoin addresses', () => {
    const content = 'Send to 1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa or bc1qw508d6qejxtdg4y5r3zarvary0c5xw7kv8f3t4 or 3J98t1WpEZ73CNmQviecrnyiWrnqRhWNLy';
    const tokens = parseContent(content);
    
    const btcAddresses = tokens.filter(t => t.type === TokenType.BITCOIN_ADDRESS);
  ...
  it('should parse Cashu tokens', () => {
    const content = 'Here is a cashu token: ';
    const tokens = parseContent(content);
